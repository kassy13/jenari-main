...
const HowToDonate = () => {
  return (
    <div className="px-20 flex flex-col lg:flex-row justify-between items-center">
      <div className="w-full ">
        <p className="text-secondary-bg text-2xl tracking-tighter pb-3">
          How to donate
        </p>
        <h3 className="text-3xl font-bold pb-2">How Can You Help?</h3>
