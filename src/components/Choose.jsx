...
const Choose = () => {
  ...
  return (
    <div className=" mx-6 lg:mx-14 lg:py-12">
      <h2 className="text-center font-extrabold text-2xl text-secondary-bg lg:pb-4">
        Why Choose JENARI?
      </h2>
      <p className="text-center text-2xl lg:text-4xl tracking-tight py-3">
        Discover why we are your ultimate online
        <span>
          <br className="hidden lg:block" /> fresh food and grocery destination
        </span>
      </p>
      <div className="flex flex-col lg:flex-row justify-between w-full mt-10 gap-7 lg:py-5">
        <div className="w-full relative">
          <img
            src={frame}
            alt=""
            className="w-full h-[65vh] lg:h-full object-top object-cover rounded-lg lg:absolute"
          />
        </div>
