...
const ShopHome = () => {
  return (
    <div className="w-full bg-[#881739] flex flex-col lg:flex-row items-center h-[70vh] lg:h-96 relative gap-6 mt-8">
      ...
      <div className="w-full lg:w-[60%] h-[55%] lg:h-full absolute right-0  lg:pl-64 bottom-0 lg:top-[-75px] ">
        <img
          src={mockup}
          alt=""
