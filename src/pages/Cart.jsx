...
const Cart = () => {
  ...
  return (
    ...
    //       <div className="grid grid-cols-10  lg:gap-4 border-b pb-4 font-semibold text-gray-700 p-3 items-center lg-text-base text-sm">
    ...
    //             <div
    //               key={product.id}
    //               className="grid grid-cols-10 max-w-4xl gap-4 items-center border-b py-4 px-6 bg-white lg-text-base text-sm"
    //             >
